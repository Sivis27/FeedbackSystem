...
public class SendEmailService {
	...
	public  void generateAndSendEmail(EmailInfo emailInfo, String filePathStr) throws AddressException, MessagingException {
		...
		// add email addresses
		recipients[0] = "sivasankart24@Gmail.com";
		recipients[1] = "Sivasankar.T2@cognizant.com";
		recipients[2] = "vimala.mathan@gmail.com";
		recipients[3] = "thangavelsamykalimuthugounder@gmail.com";

		for (String gg : recipients) {
		...
		generateMailMessage.addRecipient(Message.RecipientType.CC, new InternetAddress("sivismercury@gmail.com"));
